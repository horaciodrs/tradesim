...
## Installation:
Remember **TradeSim it's under development and it's on alpha state**. Only install for testing. Run the command **sudo ninja install** into the terminal. In the future you can install from **Elementary Os App Center.**